...
curl -k https://raw.githubusercontent.com/packetalien/pan_liab_Installer/beta/utility_scripts/etc.tar.gz -o etc.tar.gz
echo "Unpacking the server config files."
echo "Please enter password: Paloalto1!"
su -
rm -rf /etc/
